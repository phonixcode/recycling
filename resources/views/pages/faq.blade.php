    ...
    <div class="position-relative bg-primary overflow-hidden">
        <div class="container position-relative zi-2 content-space-3 content-space-md-5">
            <div class="w-md-75 w-xl-65 text-center mx-md-auto">
                <!-- Heading -->
                <div class="mb-7">
                    <h1 class="display-4 text-white text-capitalize mb-4">FAQ</h1>
                    <p class="lead text-white text-capitalize mb-4">Search our FAQ for answers to anything you might ask.</p>
                </div>
